...
| **Favorite Mobile Web Browser** | Chrome (Goole Feed, Easiest To Use), Arc Search, Firefox, Iceraven (Extension Support), & Tor (Complete Privacy) |
| **Favorite Operating Systems** | Linux (Zorin, Debian, KDE-Neon), Android (9-14), Windows (10, Windows 10 X-Lite Neongamer, & 11), & Fyde-OS (Has Linux & Android Subsystems)  |
